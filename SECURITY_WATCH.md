...
- **Déployé + vérifié** : pause `21dzHNMof4…` ; deploy SBPFv3 `5mAi7ozd…` (slot 477943093, prog `4d2SYx8…` — ⚠️ l'ID de l'époque, avant la rotation de clés du 2026-08-08 ; **ne pas « corriger » en `DgD37Vjs…`**, ce serait réécrire un fait daté) ; **preuve inverse** — même exploit rejoué post-fix par wallet neuf `9YHzCK8v…` → **`NothingToClaim` (6007)** au lieu de ~59 oSOLA ; unpause `5LgkpVJC…`.

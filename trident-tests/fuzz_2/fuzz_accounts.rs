...
pub struct AccountAddresses {
    ...
    pub partner_usdc: AddressStorage,

    pub partner_position: AddressStorage,
    ...
    pub partner_allocation: AddressStorage,
    ...
    pub team_wallet: AddressStorage,

    pub team_lock_position: AddressStorage,

    pub team_ve_lock_vault: AddressStorage,

    pub team_position: AddressStorage,

    pub partner_token: AddressStorage,

    pub contributor_wallet: AddressStorage,

    pub partner_wallet: AddressStorage,

    pub vote_escrow_vault: AddressStorage,

    pub vote_config: AddressStorage,

    pub payer: AddressStorage,

    pub old_bribe_vault: AddressStorage,

    pub old_bribe_token_vault: AddressStorage,

    pub old_gauge_state: AddressStorage,

    pub new_bribe_vault: AddressStorage,

    pub new_bribe_token_vault: AddressStorage,
